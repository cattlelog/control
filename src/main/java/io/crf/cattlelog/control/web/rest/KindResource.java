...
/**
 * REST controller for managing {@link io.crf.cattlelog.control.domain.Kind}.
 */
@RestController
@RequestMapping("/api")
public class KindResource {
    ...
    private static final String ENTITY_NAME = "controlKind";
    ...
    public KindResource(KindService kindService) {
